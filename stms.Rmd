...
### This page:
+ brief overview of state-and-transition simulation models (STSM)
...
1. Download and install [SyncroSim](https://syncrosim.com/) and the [ST-Sim](https://syncrosim.com/packages/) package
