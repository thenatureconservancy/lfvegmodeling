...
1. We demonstrate the SyncroSim modeling framework. SyncroSim is a flexible software environment for exploring and manipulating LANDFIRE vegetation models
...
4. We introduce techniques for accounting for impacts from climate change in the LANDFIRE vegetation models
