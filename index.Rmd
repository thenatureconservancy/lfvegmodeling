...
No.Brief tutorials on how to use BpS models and the free modeling software, SyncroSim. When integrated into state and transition models, this framework can improve and enhance landscape predictions and research projections.  
...
```{r, echo=FALSE, out.width= "55%", out.extra='style="float:right; padding:3px"'}
knitr::include_graphics("inputmodel.png")
